...
import com.wuhf.selector.utils.RunnableHelper;
...
public class SelectorDetector {
    ...
    public void detectAndCreateSelectors(VirtualFile selectedFolder) {
        Log.d("selectedFolder " + selectedFolder.getName());
    ...
    private void createFile(final VirtualFile file, final VirtualFile folder, List<String> fileSuffixes) {
        ...
        final String fileName = (removeSuffixes(file.getName(), fileSuffixes).split("\\.")[0])+"_selector.xml";
            ...
            public void run() {
                try {
                    ...
                    if (newFile == null || !newFile.exists()) {
                        ...
                        SelectorGenerator.generate(newFile, detectStates(file, folder), folder);
                    } else {
